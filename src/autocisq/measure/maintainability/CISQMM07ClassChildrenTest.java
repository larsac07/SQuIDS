...
public class CISQMM07ClassChildrenTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQMM07ClassChildren(new HashMap<>()));
	...
	public String getIssueType() {
		return CISQMM07ClassChildren.ISSUE_TYPE;
	}

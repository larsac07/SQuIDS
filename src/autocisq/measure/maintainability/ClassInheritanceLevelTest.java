...
public class ClassInheritanceLevelTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		issueFinder.putMeasure(new ClassInheritanceLevel(new HashMap<>()));
		...
		issueFinder.setCompilationUnits(compilationUnits);
	}
	...
	public String getIssueType() {
		return ClassInheritanceLevel.ISSUE_TYPE;
	}

...
public class CISQMM21HardCodedLiteralTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQMM21HardCodedLiteral(new HashMap<>()));
	...
	public String getIssueType() {
		return CISQMM21HardCodedLiteral.ISSUE_TYPE;
	}

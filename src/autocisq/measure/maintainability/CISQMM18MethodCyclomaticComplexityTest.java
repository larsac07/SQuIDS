...
public class CISQMM18MethodCyclomaticComplexityTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQMM18MethodCyclomaticComplexity(new HashMap<>()));
	...
	private static List<Node> findControlFlowStatements(Node node) {
		...
		if (new CISQMM18MethodCyclomaticComplexity(new HashMap<>()).isControlFlowStmt(node)) {
	...
	public String getIssueType() {
		return CISQMM18MethodCyclomaticComplexity.ISSUE_TYPE;
	}

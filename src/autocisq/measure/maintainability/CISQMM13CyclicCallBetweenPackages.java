...
/**
 * The {@link CISQMM13CyclicCallBetweenPackages} class represents the CISQ
 ...
 *
 */
public class CISQMM13CyclicCallBetweenPackages extends CISQMMTypeDependentMeasure {
	...
	public CISQMM13CyclicCallBetweenPackages(Map<String, Object> settings) {
		super(settings);

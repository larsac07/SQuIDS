...
/**
 * The {@link Class10OrMoreChildren} class represents the CISQ Maintainability
 ...
 *
 */
public class Class10OrMoreChildren extends Measure {
	...
	public Class10OrMoreChildren(Map<String, Object> settings) {
		super(settings);

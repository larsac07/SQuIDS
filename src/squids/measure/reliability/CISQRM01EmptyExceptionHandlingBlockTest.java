...
public class CISQRM01EmptyExceptionHandlingBlockTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQRM01EmptyExceptionHandlingBlock(new HashMap<>()));
	...
	public String getIssueType() {
		return CISQRM01EmptyExceptionHandlingBlock.ISSUE_TYPE;
	}

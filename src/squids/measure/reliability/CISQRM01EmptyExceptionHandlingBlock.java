...
/**
 * The CISQRM01EmptyExceptionHandlingBlock class represents the CISQ Reliability Measure
 ...
 *
 */
public class CISQRM01EmptyExceptionHandlingBlock extends CISQRMReliabilityMeasure {

	public final static String ISSUE_TYPE = "CISQ RM01: Empty exception handling block";

	public CISQRM01EmptyExceptionHandlingBlock(Map<String, Object> settings) {
		super(settings);
	}

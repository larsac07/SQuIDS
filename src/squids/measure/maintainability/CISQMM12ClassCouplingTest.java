...
public class CISQMM12ClassCouplingTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQMM12ClassCoupling(new HashMap<>()));
	...
	public String getIssueType() {
		return CISQMM12ClassCoupling.ISSUE_TYPE;
	}

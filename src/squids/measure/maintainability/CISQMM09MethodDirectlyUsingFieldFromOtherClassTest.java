...
public class CISQMM09MethodDirectlyUsingFieldFromOtherClassTest extends MeasureTest {
	...
	public void setUp() throws Exception {
		...
		this.issueFinder.putMeasure(new CISQMM09MethodDirectlyUsingFieldFromOtherClass(new HashMap<>()));
	...
	public String getIssueType() {
		return CISQMM09MethodDirectlyUsingFieldFromOtherClass.ISSUE_TYPE;
	}
